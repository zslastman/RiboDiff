...
def parse_options(argv):
    ...
    optional.add_option('-d', action='store', type='int', dest='dispDiff', default=1, help='Allow different dispersions for Ribo-seq and RNA-seq count data. Off: 0; On: 1. [default: 1]')
